      ...
      <div className="container mx-auto px-4 py-14 lg:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-1">
              <a
                ...
                aria-label="LinkedIn"
                title="LinkedIn"
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-brand hover:text-ink text-white/80 flex items-center justify-center transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><Link to="/guide/fiscalita-impresa-edile" className="text-white/70 hover:text-brand">Fiscalità dell'impresa edile</Link></li>
              <li><Link to="/guide/controllo-di-gestione-impresa-edile" className="text-white/70 hover:text-brand">Controllo di gestione</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li><Link to="/guide/holding-immobiliare-edilizia" className="text-white/70 hover:text-brand">Holding per l'impresa edile</Link></li>
              <li><Link to="/guide/protezione-patrimoniale-imprenditore-edile" className="text-white/70 hover:text-brand">Protezione patrimoniale</Link></li>
              <li><Link to="/guide/scissione-immobiliare-impresa-edile" className="text-white/70 hover:text-brand">Scissione immobiliare</Link></li>
              <li><Link to="/guide/passaggio-generazionale-impresa-edile" className="text-white/70 hover:text-brand">Passaggio generazionale</Link></li>
              <li><Link to="/guide/dividendi-holding-pex" className="text-white/70 hover:text-brand">Dividendi, PEX e prelievi</Link></li>
              <li><Link to="/patrimonio" className="text-brand hover:text-brand-light font-medium">Tutte le aree patrimonio →</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <a href={`tel:${PHONE_TEL}`} className="text-white/70 hover:text-brand">{PHONE_DISPLAY}</a>
              </li>
              <li className="flex items-start gap-3">
                <Mail className="w-4 h-4 text-brand mt-0.5 shrink-0" />
                <a href={`mailto:${EMAIL}`} className="text-white/70 hover:text-brand break-all">{EMAIL}</a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div className="text-white/70 leading-snug break-all">
                  ...
                  <a href={`mailto:${PEC}`} className="hover:text-brand">{PEC}</a>
                </div>
              </li>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/50">
          ...
          <div className="flex gap-6">
            ...
            <Link to="/note-legali" className="hover:text-brand">Note legali</Link>
          </div>
        </div>
      </div>
    </footer>
