...
const SITE = "https://www.ediliziafiscale.it";
const DEFAULT_IMAGE = `${SITE}/og-image.png`;

export interface SEOProps {
  /** Exact <title> text (already includes the "| Edilizia Fiscale" suffix where desired). */
  title: string;
  description?: string;
  keywords?: string;
...
const SEO = ({
  ...
  return (
    <Head>
      ...
      {canonical && <meta property="og:site_name" content="Edilizia Fiscale" />}
