...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "L'installazione di impianti relativi a edifici resa tra soggetti passivi IVA rientra nella lettera a-ter) dell'art. 17, comma 6, del D.P.R. 633/1972: si applica il reverse charge, e si applica anche in assenza di un rapporto di subappalto. È il punto che coglie di sorpresa molti impiantisti, abituati a ragionare in termini di subappalto." },
