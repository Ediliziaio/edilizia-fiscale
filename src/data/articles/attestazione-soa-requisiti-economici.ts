...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "È il tema che collega questa guida al resto del sito, ed è quello su cui abbiamo visto più danni evitabili. Le riorganizzazioni societarie che consigliamo per proteggere il patrimonio — separare gli immobili dall'operativa, costituire una [holding](/guide/holding-immobiliare-edilizia) — riducono il patrimonio netto della società operativa. E il patrimonio netto è un requisito della qualificazione." },
    ...
    { type: "p", text: "C'è infine il tema delle persone. I requisiti tecnici richiedono direttori tecnici con determinati titoli ed esperienza documentata. Se quei requisiti sono in capo al fondatore e il fondatore esce — per cessione, per [passaggio generazionale](/guide/passaggio-generazionale-impresa-edile), per pensionamento — la qualificazione traballa. È una delle ragioni per cui il passaggio generazionale in edilizia richiede anni e non mesi." },
