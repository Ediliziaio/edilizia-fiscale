...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "L'esercizio successivo, in sede di accordo bonario, la pretesa viene definita in 71.000 euro. Da quel momento esiste un importo certo: il ricavo viene rilevato e il margine di commessa recupera. La lettura corretta dei due esercizi richiede di sapere che i due movimenti sono collegati — ed è esattamente ciò che l'informativa in nota integrativa consente." },
