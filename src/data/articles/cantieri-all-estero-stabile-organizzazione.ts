...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Accanto a questo esistono gli obblighi previsti dalla disciplina sul distacco transnazionale nello Stato in cui i lavoratori operano: comunicazioni preventive, conservazione di documentazione, designazione di un referente, rispetto delle condizioni di lavoro e retributive minime previste in quello Stato. Sono adempimenti dello Stato ospitante e cambiano da Paese a Paese." },
