...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Il costo vero di un'ora di operaio comprende molto più della retribuzione. Sopra il lordo si sommano contributi previdenziali e assicurativi, contribuzione alla [Cassa Edile](/guide/cassa-edile-come-funziona), TFR, tredicesima e quattordicesima. Sotto, il monte ore su cui dividere si riduce per ferie, permessi, festività, malattia media, formazione obbligatoria e giornate di maltempo." },
    ...
    { type: "p", text: "Se la congruità non risulta raggiunta, l'impresa viene invitata a regolarizzare entro un termine. Le strade sono due: dimostrare documentalmente che lo scostamento è giustificato — per esempio per un'elevata incidenza di forniture, per lavorazioni ad alto contenuto di materiale o per manodopera denunciata da subaffidatari — oppure versare la differenza contributiva. In assenza di regolarizzazione la mancata congruità viene segnalata e incide sul rilascio del [DURC](/guide/durc-irregolare-impresa-edile)." },
