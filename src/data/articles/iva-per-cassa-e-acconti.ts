...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Le prime tre righe sono quelle che compongono la parte prevalente del fatturato di molte imprese edili. Nelle operazioni in reverse charge l'impresa non addebita l'imposta e quindi non ha nulla da differire; in quelle in split payment l'IVA la versa l'ente committente. In entrambi i casi il regime non ha oggetto su cui operare." },
    ...
    { type: "p", text: "Per queste ultime situazioni il problema di cassa è reale ma la risposta è un'altra, ed è quella descritta nelle guide su split payment e flussi di cassa: gestione attiva del credito IVA con rimborsi infrannuali, anticipazione del prezzo negli appalti pubblici, e leve operative sul ciclo di incasso." },
