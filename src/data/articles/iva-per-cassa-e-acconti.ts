...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Nel regime ordinario l'IVA sulle prestazioni di servizi è esigibile all'atto del pagamento del corrispettivo, ma se la fattura viene emessa prima l'imposta diventa dovuta con l'emissione. Nella pratica delle imprese edili, che fatturano i [SAL](/glossario#sal) alla loro maturazione, questo significa spesso versare l'imposta molto prima di incassarla." },
    ...
    { type: "p", text: "La verifica del primo passaggio è immediata. I subappalti sono in reverse charge e i lavori pubblici in [split payment](/glossario#split-payment): entrambi fuori dal regime. La base su cui l'IVA per cassa potrebbe operare è quindi limitata ai 700.000 euro di lavori per privati, meno di un terzo del fatturato." },
