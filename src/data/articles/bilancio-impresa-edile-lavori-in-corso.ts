...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "È per questo che la valutazione delle commesse non è un adempimento contabile di fine anno: è il risultato di un processo di controllo che deve funzionare tutto l'anno. Se i [costi a finire](/glossario#costi-a-finire) non sono aggiornati mensilmente, a dicembre non c'è modo di produrre una valutazione attendibile." },
