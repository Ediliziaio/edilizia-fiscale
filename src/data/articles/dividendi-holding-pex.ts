...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Se la risposta è che serve tutto l'utile, la [holding](/guide/holding-immobiliare-edilizia) non produce vantaggi: il 26% si paga comunque, con un passaggio in più e i costi di una società aggiuntiva. Se la risposta è che serve una parte e il resto va reinvestito, la holding consente di far circolare la parte reinvestita quasi integra." },
    ...
    { type: "p", text: "L'implicazione pratica è rilevante per chi progetta una riorganizzazione: se la beneficiaria della [scissione immobiliare](/guide/scissione-immobiliare-impresa-edile) sarà un giorno ceduta, la plusvalenza sulle sue quote potrebbe non godere dell'esenzione. Va tenuto presente nel disegno dell'assetto, valutando se e come l'immobiliare svolge attività qualificabile come commerciale." },
