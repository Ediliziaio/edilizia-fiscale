...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Vanno inoltre verificate, misura per misura, le regole sulla cumulabilità con altre agevolazioni sullo stesso investimento e sull'utilizzo del credito in compensazione, che tipicamente avviene in quote annuali e incontra i vincoli generali alla compensazione già descritti nella guida sui crediti incagliati." },
