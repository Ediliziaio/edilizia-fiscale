...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Se un artigiano in regime forfettario affida una lavorazione a un altro operatore e riceve una fattura in [reverse charge](/guide/reverse-charge-edilizia) — ad esempio per un'installazione di impianti su edificio, o per un subappalto nel settore costruzioni — deve integrare quella fattura con l'aliquota e l'imposta, annotarla e versare l'IVA. E non può detrarla, perché il regime non lo consente." },
