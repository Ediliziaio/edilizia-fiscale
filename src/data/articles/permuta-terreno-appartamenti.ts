...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Ne segue una regola pratica che diamo sempre: la permuta va inserita nel [piano di cassa dell'iniziativa](/guide/flussi-di-cassa-impresa-edile) come qualunque altra uscita, quantificando gli oneri del primo atto e collocandoli nel mese in cui matureranno. Un'operazione che sulla carta non richiede capitale, nella realtà richiede la disponibilità per gli oneri iniziali e per l'intera costruzione." },
    { type: "p", text: "Va poi considerata la garanzia della controparte. Il proprietario che cede l'area oggi riceverà le unità tra anni, e nel frattempo il costruttore potrebbe non completare. Le tutele — [fideiussioni](/guide/vendita-su-carta-acconti-garanzie), condizioni risolutive, riserva di proprietà, trascrizioni — sono materia contrattuale ma hanno un costo che va messo a preventivo, e sono la ragione per cui una permuta ben fatta richiede assistenza legale oltre che fiscale." },
