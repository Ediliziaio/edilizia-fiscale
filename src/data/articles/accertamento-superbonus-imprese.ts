...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Quando arriva un atto di recupero, la prima domanda non è quanto chiedono ma come qualificano il credito. Un credito non spettante e un [credito inesistente](/glossario#credito-inesistente) possono riguardare lo stesso importo e produrre conseguenze radicalmente diverse: cambia la misura della sanzione, cambiano i termini entro cui l'amministrazione può agire, cambia l'eventuale rilevanza penale della vicenda." },
