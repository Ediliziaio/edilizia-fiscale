...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Il primo passaggio è qualificare il venditore. Una persona fisica che vende un immobile non agisce nell'esercizio d'impresa — il confronto tra le due vesti è il tema della guida su [società immobiliare o persona fisica](/guide/societa-immobiliare-o-persona-fisica) —: l'operazione è fuori campo IVA e sconta le imposte di registro, ipotecaria e catastale, con eventuale plusvalenza tassabile se ricorrono i presupposti. Una società o un imprenditore che vende nell'esercizio dell'attività ricade invece nella disciplina IVA delle cessioni di fabbricati." },
