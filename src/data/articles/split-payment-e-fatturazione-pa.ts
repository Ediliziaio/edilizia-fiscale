...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Il risultato è un credito IVA che cresce a ogni [SAL](/glossario#sal). Su una commessa pubblica da 800.000 euro con acquisti imponibili per 400.000 euro, il credito generato in un esercizio è nell'ordine delle decine di migliaia di euro: liquidità immobilizzata che, se non gestita, si somma alla tensione di cassa già tipica del lavoro pubblico." },
