...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Il secondo è la verifica della congruità dell'incidenza della manodopera, introdotta dal D.M. 143/2021: il costo del lavoro denunciato in [Cassa Edile](/guide/cassa-edile-come-funziona) viene confrontato con percentuali minime riferite al valore dell'opera, e lo scostamento non giustificato incide sul DURC. Per la nuova edilizia civile il riferimento consolidato è il 14,28%." },
    { type: "p", text: "Il terzo, per chi lavora con la pubblica amministrazione, è lo [split payment](/glossario#split-payment): l'IVA viene versata direttamente dall'ente committente, e l'impresa incassa il solo imponibile. Sul piano fiscale è neutro; sul piano finanziario no, perché genera strutturalmente crediti IVA da gestire con richieste di rimborso o compensazione." },
