...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "È la domanda da cui partire, perché la congruità viene confusa di continuo con il DURC ordinario. Il DURC guarda i versamenti: hai pagato quello che hai denunciato? La congruità guarda le denunce: hai denunciato abbastanza manodopera per aver realizzato quell'opera?" },
