...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "C'è poi una ragione di sviluppo: la società consente di far entrare soci o familiari, di costruirci sopra una holding, di accedere a qualificazioni e a un rapporto bancario più strutturato. Sono possibilità che la ditta individuale semplicemente non offre." },
    ...
    { type: "p", text: "Il punto sui contratti merita un'aggiunta pratica: nei rapporti con committenti pubblici e con banche il subentro va comunicato e talvolta autorizzato, e i tempi non sono immediati. Programmare il conferimento a ridosso di una scadenza di gara o di una liquidazione di SAL è un errore di calendario che costa più della complessità tecnica dell'operazione." },
    ...
    { type: "p", text: "Il terzo punto è quello che l'imprenditore sottovaluta di più. Attestazione SOA e rating bancario si fondano su bilanci pluriennali: una società costituita oggi parte da zero come storia, anche se l'attività va avanti da quindici anni. Chi rinvia il passaggio rinvia anche l'inizio di quell'orologio." },
    { type: "p", text: "Va infine considerato il collegamento con la protezione patrimoniale descritta nelle altre guide: la S.r.l. è il primo mattone. Sopra ci si può costruire una holding, separare gli immobili, pianificare il passaggio ai figli. Su una ditta individuale nessuna di queste cose è possibile." },
