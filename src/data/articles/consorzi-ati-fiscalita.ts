...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Se collabori stabilmente con le stesse imprese e ogni volta costituisci un raggruppamento nuovo, vale la pena fare il conto: quante gare all'anno fate insieme, quali importi vi sfuggono per classifica insufficiente, quanto costerebbe una struttura consortile. Mandaci le attestazioni delle imprese coinvolte e l'elenco delle gare degli ultimi due anni dalla pagina contatti: valutiamo se il consorzio stabile si ripaga e come impostare i rapporti interni. Per il contesto leggi le guide su [attestazione SOA](/guide/attestazione-soa-requisiti-economici) e gruppo societario." },
