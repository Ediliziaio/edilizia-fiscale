...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Il contenuto è quello del fascicolo di commessa: contratto e computo metrico, titolo edilizio e comunicazioni, [SAL](/glossario#sal) e asseverazioni, fatture e bonifici parlanti, documentazione fotografica datata, documenti di trasporto dei materiali, denunce del personale impiegato. Se manca una di queste voci, va ricostruita ora, perché la sua assenza pesa." },
