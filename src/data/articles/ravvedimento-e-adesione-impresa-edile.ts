...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Impresa che scopre, in sede di revisione interna, di aver applicato per tre esercizi l'aliquota IVA del 10% su interventi di manutenzione straordinaria senza gestire la regola dei [beni significativi](/guide/iva-agevolata-lavori-edili). La maggiore imposta stimata è di 84.000 euro complessivi sui tre anni." },
