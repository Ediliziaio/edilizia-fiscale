...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Su questa agevolazione grava però un limite che vale solo per la manutenzione: la regola dei [beni significativi](/glossario#beni-significativi). Per un elenco tassativo di beni — ascensori e montacarichi, infissi esterni e interni, caldaie, videocitofoni, apparecchiature di condizionamento e riciclo dell'aria, sanitari e rubinetteria da bagno, impianti di sicurezza — l'aliquota ridotta si applica al valore del bene solo fino a concorrenza del valore della prestazione di posa. Sull'eccedenza si applica il 22%." },
