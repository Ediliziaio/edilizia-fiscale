...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "L'effetto finanziario va capito bene, perché è sistematico e non occasionale. Su una fattura da 100.000 euro più IVA, pagata con [bonifico parlante](/glossario#bonifico-parlante), all'impresa arriva l'imponibile decurtato dell'8%: 8.000 euro restano nelle mani dell'erario come acconto. Un'impresa che lavora prevalentemente su interventi agevolati subisce questo prelievo su ogni incasso, e se non lo mette a budget si ritrova una tensione di cassa che non sa spiegarsi." },
