...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Le condizioni sono quelle consuete dei benefici contributivi, e sono cumulative: regolarità contributiva attestata dal [DURC](/guide/durc-irregolare-impresa-edile), rispetto degli obblighi previsti dagli accordi collettivi nazionali e territoriali, assenza di provvedimenti che precludano l'accesso ai benefici. La verifica non è formale: un DURC irregolare non sospende soltanto il beneficio, ne comporta il recupero per il periodo di irregolarità." },
    ...
    { type: "p", text: "Due verifiche che spesso restituiscono denaro: se l'istanza per la riduzione contributiva di settore è stata presentata, e se il costo orario che usi nei preventivi la considera. Mandaci il libro unico dell'ultimo esercizio e i prospetti contributivi dalla pagina contatti: verifichiamo la spettanza, l'eventuale recuperabilità e l'impatto sul costo orario. Per il contesto leggi le guide su costo del lavoro edile, [Cassa Edile](/guide/cassa-edile-come-funziona) e DURC irregolare." },
