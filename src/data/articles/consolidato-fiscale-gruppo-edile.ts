...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Distinto dal consolidato ai fini delle imposte dirette è lo strumento della liquidazione IVA di gruppo, che consente di compensare le posizioni a debito e a credito delle società partecipanti con un versamento unitario. Per un gruppo edile può essere rilevante, perché è frequente che una società accumuli credito IVA — lavorando in reverse charge o in split payment — mentre un'altra versa regolarmente." },
