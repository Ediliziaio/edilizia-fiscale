...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "A questo si somma l'effetto sulla qualificazione, descritto nella guida sull'[attestazione SOA](/guide/attestazione-soa-requisiti-economici): dalla terza classifica in su la certificazione di qualità è comunque richiesta. Le due esigenze convergono, e vale la pena valutarle insieme invece che come due spese separate." },
    ...
    { type: "p", text: "I premi delle garanzie e delle polizze sono costi inerenti e deducibili secondo il principio di competenza. La questione rilevante, come per i [costi della sicurezza](/guide/oneri-della-sicurezza-trattamento), non è la deducibilità ma la corretta imputazione temporale e per commessa." },
    ...
    { type: "p", text: "Alla stipula scattano le due garanzie definitive; su entrambi gli appalti l'impresa chiede l'[anticipazione del prezzo](/guide/anticipazione-e-revisione-prezzi), e servono le relative fideiussioni. Nel giro di poche settimane il plafond disponibile si è ridotto in misura sostanziale, e per la gara successiva — quella che l'imprenditore considerava la più interessante dell'anno — la garanzia provvisoria non è più rilasciabile." },
    { type: "p", text: "Le leve praticabili sono tre e vanno usate insieme. Presidiare gli svincoli progressivi delle garanzie definitive sui due appalti in corso, liberando plafond man mano che l'esecuzione avanza. Verificare la riduzione della fideiussione sull'anticipazione a ogni recupero sui [SAL](/glossario#sal). E, dal lato strutturale, presentare agli istituti un dossier con margine per commessa e cassa prospettica per rinegoziare il massimale complessivo." },
    { type: "p", text: "La terza è quella che risolve davvero, ma è anche quella che richiede più tempo e che va avviata prima di averne bisogno. È lo stesso principio della [protezione patrimoniale](/guide/protezione-patrimoniale-imprenditore-edile): gli strumenti si costruiscono quando l'azienda è in salute, non quando servono." },
