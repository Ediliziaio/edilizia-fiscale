...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "La terza ragione è più insidiosa. In edilizia il conto economico dipende in modo determinante dalla valutazione dei lavori in corso, che a sua volta dipende dai costi a finire stimati. Se quella stima è ottimistica, il bilancio espone un utile che non esiste: non è una manipolazione, è il risultato meccanico di un dato non aggiornato. Un controllo di gestione serio è anche il presidio che rende affidabile il bilancio." },
