...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "La neutralità fiscale non è un salvacondotto. L'operazione deve avere ragioni economiche extrafiscali reali e documentabili, altrimenti è contestabile come [abuso del diritto](/glossario#abuso-del-diritto) ai sensi dell'art. 10-bis della legge 212/2000. La norma stessa, però, afferma che resta ferma la libertà di scegliere tra operazioni comportanti un diverso carico fiscale, quando la scelta ha una ragione." },
