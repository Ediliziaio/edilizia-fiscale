...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "La scelta è di non adeguarsi e di predisporre invece un fascicolo esplicativo: prospetto dei lavori in corso per commessa con percentuali di avanzamento, contratti, [SAL](/glossario#sal) approvati, e un raffronto triennale che mostra come il ciclo delle commesse spieghi l'andamento degli indicatori. Nell'esercizio successivo, con la consegna delle due commesse, il punteggio risale senza alcun intervento." },
