...
export const article: Article = {
  ...
  content: [
    ...
    { type: "p", text: "Sul piano della valutazione, l'elemento su cui si costruisce la stima è il preventivo dei costi a finire, esattamente come nelle commesse. È lo stesso dato di controllo di gestione: senza costi a finire aggiornati non si può né valutare la commessa né verificare la recuperabilità del valore delle rimanenze." },
