...
- Stack: Vite + React + TypeScript + Tailwind + shadcn/ui, **SSG con vite-react-ssg** (72 pagine prerenderizzate).
...
- **Guide** (`/guide`, `/guide/[slug]`): 40 articoli in `src/data/articles/*.ts` — formato a blocchi
...
- immagini: 122 slot in tutto (40 copertine guida, 76 figure, 6 di sito), tutti a `null`.
